 ...
 * @author Loyola
 */
public class p_Dccorriente_upd {
    private int Accion;
    ...
    public p_Dccorriente_upd(Coneccion strCn,DccorrienteBE objDccorrienteBE) {
    ...
    public p_Dccorriente_upd(Connection strCn,DccorrienteBE objDccorrienteBE) {
        this.Accion = objDccorrienteBE.getAccion();
        this.Id_Dccorriente = objDccorrienteBE.getId_Dccorriente();
        this.Id_Ccorriente = objDccorrienteBE.getId_Ccorriente();
        this.Id_Transaccion = objDccorrienteBE.getId_Transaccion();
