 ...
 * @author Loyola
 */
public class p_Dccorriente_del {
    private int Accion;
    ...
    public p_Dccorriente_del(Coneccion strCn,DccorrienteBE objDccorrienteBE) {
    ...
    public p_Dccorriente_del(Connection strCn,DccorrienteBE objDccorrienteBE) {
        this.Accion = objDccorrienteBE.getAccion();
        this.Id_Dccorriente = objDccorrienteBE.getId_Dccorriente();
        this.Id_Ccorriente = objDccorrienteBE.getId_Ccorriente();
        this.Id_Transaccion = objDccorrienteBE.getId_Transaccion();
