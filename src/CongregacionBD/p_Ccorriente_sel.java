...
public class p_Ccorriente_sel {
    ...
    public p_Ccorriente_sel(int Accion, int Id_Ccorriente, int Id_Mensual, Date Fecha, int Id_Concepto, double Cuentan, double Importe, String Flagactivo) {
        this.Accion = Accion;
    ...
    public p_Ccorriente_sel(Coneccion strCn,CcorrienteBE objCcorrienteBE) {
    ...
    public p_Ccorriente_sel(Connection strCn,CcorrienteBE objCcorrienteBE) {
        this.Accion = objCcorrienteBE.getAccion();
        this.Id_Ccorriente = objCcorrienteBE.getId_Ccorriente();
        this.Id_Mensual = objCcorrienteBE.getId_Mensual();
        this.Fecha = objCcorrienteBE.getFecha();
